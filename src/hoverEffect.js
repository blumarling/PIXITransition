...
export default function(opts) {
  ...
  var image3 = opts.image3 || console.warn("second image missing");
  ...
  var texture1 = loader.load(image1, (tex) => {
    tex.needsUpdate = true;
    // manteniamo l'aspect ratio corretto
    object.scale.set(1.0, tex.image.height / parent.offsetHeight, 1.0);
  });

  var texture2 = loader.load(image2,(tex) => {
    tex.needsUpdate = true;
    object.scale.set(1.0, tex.image.height / parent.offsetHeight, 1.0);
  });
